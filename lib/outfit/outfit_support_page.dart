...
/// Assistenza diretta MOODFIT — collection `support` sul progetto Outfit.
class OutfitSupportPage extends StatefulWidget {
  const OutfitSupportPage({super.key});

  @override
  State<OutfitSupportPage> createState() => _OutfitSupportPageState();
}

class _OutfitSupportPageState extends State<OutfitSupportPage> {
  ...
  Widget build(BuildContext context) {
    return OutfitAvailability(
      child: _OutfitSupportBody(replyControllers: _replyControllers),
    );
  }
}

class _OutfitSupportBody extends StatelessWidget {
  const _OutfitSupportBody({required this.replyControllers});
    ...
    return Column(
      ...
      children: [
        const SectionHeader(
          ...
          subtitle: 'Ticket e chat dell\'app MOODFIT (collection support).',
        ),
        Expanded(
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final replyCtrl = replyControllers.putIfAbsent(
                    ticket.id,
